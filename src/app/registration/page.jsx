  ...
  const onSubmit = async (data) => {
    try {
      ...
      const res = await axios.post(
        "http://localhost:3000/registration/api",
        data
      );
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
          <div class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
            <div class="absolute inset-0">
              <Image
                src="/assets/images/registration/mechanic.jpg"
                layout="fill"
                objectFit="cover"
                alt="image"
                className=""
            ...
            <div class="relative">
              <div class="w-full  xl:w-full xl:mx-auto xl:pr-24 ">
                <h3 class="text-4xl font-bold text-white">
                  Get Your Car Serviced by Experts &
                  <br class="hidden xl:block" />
                  Drive with Confidence
                </h3>
                <ul class="grid grid-cols-1  w-full mt-10 sm:grid-cols-2 gap-x-8 gap-y-4">
